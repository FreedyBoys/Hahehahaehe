...
-------------------------------------------------------------------------
Name =  'Enjoyers-Brutal.lua' -- Type Name For Start Script . If Someone Will Rename It , Then Script Won't Run
-------------------------------------------------------------------------
if Detector == Name then gg.alert('☑ Script Safe - Brutal : \n      '..Name)
-------------------------------------------------------------------------
else 
-------------------------------------------------------------------------
Error = '⚠ FUCK...!!! File Rename Is Detected ⚠' -- Type Error Message Here 
print(Error) 
return
end 
-------------------------------------------------------------------------
